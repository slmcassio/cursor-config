...
ln -s config/config.edn ~/.config/calva/config.edn
...
ln -s config/keybindings.json \
      ~/Library/Application\ Support/Cursor/User/keybindings.json
```

- Adjust the destination paths if your system uses different locations for these configuration files.

This setup ensures your editor and extension settings are always in sync with your repository. 
